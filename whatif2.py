...
from astar.model import (build_prediction, observation_calibrated_transitions, HISTORICAL_TRANSITIONS, RECENT_TRANSITIONS, NUM_CLASSES, apply_floor, PROB_FLOOR)
...
for seed in range(5):
    ...
    # 3. Oracle transitions (from GT) â€” ceiling for transition-based approach
    ...
    # 7. What if we knew GT Sâ†’S exactly and used it as round feature? (Oracle round features)
    ...
    print(f"  GT Sâ†’S: {gt_ss:.3f}, Calibrated Sâ†’S: {cal_ss:.3f}, Delta: {cal_ss-gt_ss:+.3f}")
